...
def load_SEREP_blendshape_model():
    ...
    return model, surrogate_model, SEREP_latent_directions, [std, mean], SEREP_neutral


SEREP_model, SEREP_surrogate, SEREP_latent_directions, [std, mean], neutral = load_SEREP_blendshape_model()
...
for i in range(0, 200):
    ...
    V_through_latent = SEREP_model.id_encoder(neutral, facs_latent_code)
